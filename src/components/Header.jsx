    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <li className="text-base text-textColor hover:text-headingColor duration-100 transi ease-in-out cursor-pointer">
              Home
            </li>
            <li className="text-base text-textColor hover:text-headingColor duration-100 transi ease-in-out cursor-pointer">
              Menu
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "abhaysinghparmar123@gmail.com" && (
                  <Link to={"/createItem"}>
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 py-2 rounded-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base"
                onClick={logOut}
              >
                Log Out <MdLogout />
              </p>
